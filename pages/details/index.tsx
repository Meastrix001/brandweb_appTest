...
import { Game, Platform, Rating, Stores, Screenshots, Screenshot, Tag, Genre, Developers, Publisher, Additions, Result, Series } from '../../types';
...
function DetailsPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            } else if (router.query.slug && router.query.slug === undefined) {
                router.push("/");
            }
          }
            ...
            <div>
                ...
                <div className={`${gameData ? "" : "d-none"} detailsGame`} >
                    ...
                    <div className={` ${currentImgModalToggle ? "modal d-block ms-auto" : "modal"}`}>
                        ...
                        <img alt="" className="m-auto" onClick={(e) => {setCurrentImgModalToggle(false)}} src={gameScreenshots?.results ? gameScreenshots?.results[currentImgModal].image : ""} />
                    ...
                    <div className="detailsGameBg">
                        <img className="" src={gameData?.background_image ? gameData?.background_image : ""} alt="" />
                    </div>
                        ...
                        <div>
                            <ul className="nav nav-tabs nav-fill" id="myTab" role="tablist">
                                <li className="nav-item" >
                                    <button onClick={(e) => {setActiveTab("about")}} className={`text-white nav-link ${activeTab == "about" ? "show active" : ""}`} >About</button>
                                </li>
                                <li className="nav-item" >
                                    <button onClick={(e) => {setActiveTab("info")}} className={`text-white nav-link ${activeTab == "info" ? "show active" : ""}`} >Info</button>
                                </li>
                                <li className="nav-item" >
                                    <button onClick={(e) => {setActiveTab("platforms")}} className={`text-white nav-link ${activeTab == "platforms" ? "show active" : ""}`} >Platforms</button>
                                </li>
                            </ul>
                        ...
                        <div>
                            <div className="d-flex row flex-wrap">
                                ...
                                <div className="col-6 col-md-4 col-lg-3">
                                    ...
                                    <p className="mb-0 text-white mb-1 ms-1 me-1">{gameData?.esrb_rating?.name == "Mature" ? "17+" : ""}     {gameData?.esrb_rating?.name} </p>
                ...
                {/* LOADER */}
                <div className={`${gameData ? "d-none" : "d-flex flex-column justify-content-center align-items-center p-4"}`}>
                    <HashLoader color="#2127c8"/>
                    <p className="text-white">Getting details from RAWG api</p>
                </div>
            </div>
        </MainContainer>
    )
